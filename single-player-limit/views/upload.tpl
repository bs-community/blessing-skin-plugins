...
<script>
  ...
  blessing.userBoundPid = {{ App\Models\Player::where('player_name', $user->player_name)->first()->pid }};
</script>
<script src="{{ plugin_assets('single-player-limit', 'assets/upload.js') }}"></script>
@endsection
