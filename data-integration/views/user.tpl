              ...
              <div class="col-md-8">
                <table class="table">
                  <tbody>
                    <tr>
                      <td class="key">
                        {{ trans('user.player.player-name') }}
                      </td>
                      <td class="value">
                        <input type="text" disabled="disabled" class="form-control" id="player-name" data-toggle="tooltip" data-placement="top" title="本站已进行数据对接，您最多只能注册一个角色，此角色名可用于登录对接程序。" value="{{ $player['player_name'] }}">
                      </td>
                    </tr>
