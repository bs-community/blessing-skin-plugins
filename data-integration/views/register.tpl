...
<div class="register-box">
    ...
    <div class="register-box-body">
        ...
        <form id="register-form">
            ...
            <div class="form-group has-feedback" title="{{ trans('DataIntegration::auth.player-name-intro') }}" data-placement="top" data-toggle="tooltip">
                <input id="player_name" type="text" class="form-control" placeholder="{{ trans('general.player.player-name') }}">
...
@section('script')
<script src="{{ plugin_assets('data-integration', 'assets/auth.js') }}"></script>
@endsection
